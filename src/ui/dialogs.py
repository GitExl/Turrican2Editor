...
class FrameMainBase ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.SetSizeHintsSz( wx.Size( 1024,728 ), wx.DefaultSize )

		SizerMain = wx.BoxSizer( wx.HORIZONTAL )

		self.Properties = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 357,-1 ), wx.NO_BORDER|wx.TAB_TRAVERSAL )
		...
		SizerProperties.AddSpacer( ( 0, 8), 0, wx.EXPAND, 0 )
		...
		self.TitleTiles.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), 70, 90, 92, False, wx.EmptyString ) )
		...
		self.Tiles = tileselector.TileSelector(self.PanelModeTiles)
		...
		self.TitleEntities.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), 70, 90, 92, False, wx.EmptyString ) )
		...
		self.Entities = entitypicker.EntityPicker(self.PanelModeEntities)
		...
		self.TitleStart.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), 70, 90, 92, False, wx.EmptyString ) )
		...
		self.MenuGame.AppendItem( self.GameExit )
